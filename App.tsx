...
function App() {
  ...
  return (
    <div className="min-h-screen font-sans text-royal-blue overflow-x-hidden bg-paper">
      {/* BACKGROUND LAYERS */}
      <div className="fixed inset-0 z-[-2] bg-[#F9FAFB]" />

      {/* Watercolor Texture */}
      <div
        className="fixed inset-0 z-[-1] opacity-40 pointer-events-none mix-blend-multiply"
        style={{
          backgroundImage: "url('/walimatul_nikah/images/watercolor.jpg')",
